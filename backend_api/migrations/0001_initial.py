# Generated by Django 2.0.6 on 2018-10-13 07:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_deleted_timestmap', models.IntegerField(null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('uuid', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='backend_api.User')),
        ...
        migrations.AddField(
            ...
            name='user_one',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_one', to='backend_api.User'),
        ),
        migrations.AddField(
            model_name='userchatmapping',
            name='user_two',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_two', to='backend_api.User'),
        ),
        migrations.AddField(
